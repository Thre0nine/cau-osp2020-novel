...
제리가 계속해서 그녀의 푸른 눈에 대해서 말할 때마다 제리가 어떻게 그 사실을 알고 있는지 끊임없이 의심했지만
의심하면 의심할 수록 그녀와의 추억이 떠올랐다.

```
그럴리가 없는데..
제리가 어떻게 미야를 아는 거지?
```
생각하면 생각할수록 이성적 사고가 사랑이라는 감성에 밀렸다.
```
다시 한 번... 볼 수 있을까? 
```
...
```
자. 그럼 톰을 데려오는 방법을 알려주지. 쉽지는 않겠지만 말이야.
...
```
톰은 동화 오즈의 마법사를 떠올렸다.
동화 오즈의 마법사 속 오즈의 마법사도 도로시와 그 일행을 속인 사기꾼이었다.
...
톰은 두번 다시 만나기 힘들 것이라고 생각했던 제리를 다시 만나서 기뻤고,
집사들이 자신을 찾고있다는 생각에 너무 기뻤다.
